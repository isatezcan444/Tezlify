...
const st = { qr: null, status: 'SCAN_QR', sessionId: null, phone: null, pairingCode: '12345678', pairFails: false };
let tokenSeq = 0;
let closes = 0;
...
let root = null;
let props = { existingSessionId: undefined };
...
window.__h = {
  ...
  reset: function (propsPatch, statePatch) {
    ...
    st.pairingCode = '12345678'; st.pairFails = false;
  ...
  state: function () {
    ...
    return {
      ...
      text: (bodyEl().textContent || '').slice(0, 400),
